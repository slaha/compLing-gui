...
class NodeDegreePanel extends JPanel {
	...
	public void set(int edgesCount, int nodeCount, double result) {

		nominator.setText("2 × " + edgesCount);
		denominator.setText(nodeCount + " × (" + nodeCount + " − 1)");
